...
if (isset($_POST['addRatingBtn'])) {
    ...
    $sql1 = " INSERT INTO danhgia (MaDG,MaTV,MaSP,DiemDG,Binhluan)
   VALUES('$MaDG','$userID','$productID','$DiemDG','$Binhluan'); ";
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 align-self-start mt-5">
                    ...
                    <p>
                        ...
                        <?php } ?>
                        <span class="text-danger h4"><strong>
                    ...
                    <form role="form" action="giohang.php" method="post">
                        ...
                        <div class="number form-group mb-3">
                            ...
                            <input type="number" class="input-sm rounded" id="soluong" name="soluong" value="1"
                                min="1" />
                        </div>
                        ...
                        <!-- Button -->
                        <div class="mb-3">
                            <button type="submit" class="btn btn-warning me-2" name="addtocartbtn" value="1">Thêm vào
                                giỏ hàng</button>
