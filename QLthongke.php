...
<head>
    ...
    <style>
        .table {
            ...
            /* Gộp viền để có cái nhìn sạch sẽ hơn */
        ...
        .table td {
            ...
            /* Đường viền màu xám nhạt cho ô bảng */
            padding: 12px;
            /* Khoảng cách cho ô bảng */
            text-align: center;
            /* Căn giữa văn bản */
        }
        ...
        .table th {
            ...
            /* Màu nền nhạt cho tiêu đề bảng */
            color: #343a40;
            /* Màu chữ tối cho tiêu đề bảng */
            font-weight: bold;
            /* Làm cho văn bản tiêu đề in đậm */
        }
        ...
        .chart-container {
            ...
            /* Đường viền tối màu xung quanh biểu đồ */
            border-radius: 8px;
            /* Góc bo tròn */
        ...
        h2 {
            margin-top: 40px;
            /* Khoảng cách phía trên tiêu đề phần */
            margin-bottom: 20px;
            /* Khoảng cách phía dưới tiêu đề phần */
            text-align: left;
            /* Căn trái tiêu đề */
            margin-left: 5px;
        ...
        h5 {
            ...
            /* Căn giữa tiêu đề phụ */
            margin-top: 20px;
            /* Khoảng cách phía trên tiêu đề phụ */
            margin-bottom: 20px;
            /* Khoảng cách phía dưới tiêu đề phụ */
            font-style: italic;
            /* Đặt kiểu chữ nghiêng cho tiêu đề phụ */
        }

        /* Màu chữ tùy chỉnh cho bảng */
        .table td {
            color: #495057;
            /* Màu chữ tối hơn cho dữ liệu bảng */
        }
