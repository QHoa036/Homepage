        ...
        <div class="container-fluid bg-flashsale">
            <div class="row">
                <div class="col-md-6 p-0">
                    <div class="row-2 bg-flash-countdown">
                        <img src="assets/imgs/buttons/btn_flashsale.png" alt="" />
                        <p class="bg-flash-countdown-text">FLASH SALE: <span class="ms-2" id="countdown" /></p>
                    </div>
                    ...
                    <div class="row-10">
                        <div class="bg-flash-info shadow-sm border-4">
                            ...
                            <div class="bg-flash-info-body">
                                <p class="content">Mã SP: <strong>SP5</strong></p>
                                ...
                                <p class="price-info">Đã bán: <strong>500 sp</strong></p>
                ...
                <div class="col-md-6">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <img src="assets/imgs/products/discount_1.png" alt="">
                        </div>
                        <div class="item">
                            <img src="assets/imgs/products/discount_2.png" alt="">
                        </div>
                        <div class="item">
                            <img src="assets/imgs/products/discount_3.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
